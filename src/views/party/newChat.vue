  ...
  <div style="position:fixed; top:0; left:0; width:100%; height:100%; background:#f5f5f5;">
    ...
    <div style="background:#fff;">
      <mu-container style="width:100%; height:100%; border-radius:.5rem; padding:.5rem .5rem 0 .5rem;">
        <mu-text-field v-model="c_cont" multi-line :rows="7" :rows-max="10" full-width :max-length="200" underline-color="rgba(139, 69, 19, .2)" placeholder="说一句呗：" style="font-size:14px;">
        </mu-text-field>
      </mu-container>
    </div>
