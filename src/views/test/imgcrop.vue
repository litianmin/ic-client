<template>
  <div id="demo" style="width:100%;">
    ...
    <div class="father" v-show="panel">
      <div class="container">
        <div id="cropper" style="margin-top:1%;  height: 85%; margin-bottom: 1%">
          <img id="image" :src="url" alt="Picture">
        </div>
        <div>
          <div style="float: right;margin-right: 1%">
            <mu-button  @click="zoom(-1)">缩小</mu-button>
            <mu-button  @click="zoom(1)">放大</mu-button>
            <mu-button  @click="rotate">翻转</mu-button>
            <mu-button  @click="crop">剪切</mu-button>
            <mu-button  @click="panel=false">返回</mu-button>
          </div>
        </div>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      crop () {
        ...
        */
        //方形
        this.headerImage = croppedCanvas.toDataURL('image/jpeg', 0.1);  // 这里可以改变它的比例
