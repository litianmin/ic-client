            ...
            <div slot="header" style="padding:.5rem 0 1rem 0;">
              ...
              <mu-row style="margin-top:.2rem;" gutter>
                ...
                <mu-col col="6" justify-content="center" align-items="center">
                  <mu-flex justify-content="center" align-items="center" style="width:100%; height:10rem; text-align:center; border-radius:.5rem; margin-top:.5rem; ">
                    <img style="max-width:100%; max-height:10rem; border-radius:.5rem;" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1556172407865&di=6171b22f5c8d59e11d35faef8afe7d54&imgtype=0&src=http%3A%2F%2Fimgsa.baidu.com%2Fexp%2Fw%3D500%2Fsign%3D4332c8a0dd54564ee565e43983df9cde%2Fb812c8fcc3cec3fdf66553c6d688d43f8794272d.jpg" />
                  </mu-flex>
                </mu-col>
              </mu-row>
